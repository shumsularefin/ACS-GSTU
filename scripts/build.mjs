...
for(const name of ['site-shell.js','homepage.js','editor-access.js','admin-access-panel.js','content-model.js','content-render.js','public-content.js','admin.js','cloud-editor.js','excel-worker.js','certificate-model.js','certificate-render.js','certificate-admin.js','verify.js'])fs.copyFileSync('js/'+name,'public/js/'+name);
